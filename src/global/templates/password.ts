                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          We received a password reset request for your account: <span style="color: #4C83EE;">{{email}}</span>. Click the button below to proceed. The password reset link is only valid for the next 24 hours.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 0 0 24px 0;">
                          <a class="button" href="{{url}}/reset-password?token={{token}}" title="Reset Password" style="width: 100%; background: #22D172; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Reset Password</a>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>{{app}}</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
